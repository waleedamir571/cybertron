            ...
            <div class="container-fluid px-4">
              <div class="row align-items-end">
                ...
                <div class="col-md-6">
                  <h1 class="display-5 fast">
                    Build Fast<br>
                    <span class="purple">Scale Smart</span><br>
                    with <span class="bold">Cybertron</span>
                  </h1>
                  <div class="d-flex gap-3 mt-4">
                    <a href="#" class="btn btn-light text-primary fw-semibold">Get in Touch</a>
              ...
              <div class="row pt-80">
               <div class="col-md-6 offset-md-6 text-md-end mt-4 mt-md-0">
                  <p class="client-name">
                    Flexible teams and future-ready tech to drive <br> your business forward.
                  </p>
                </div>
                </div>
            </div>
        ...
        <div class="row align-items-baseline">
          ...
          <div class="col-md-9">
            <p class="cybertron-heading mt-65 color-900 text-opacity">
              We solve problems, not just deliver code. Here’s a glimpse into how our work mindset is creating value
              across industries—even before the results go live.
            </p>
            <br><br>
      ...
      <div class="container-fluid">
        <div class="row align-items-baseline">
          <div class="col-md-6 " data-aos="fade-right">
            ...
            <p class="create">We create <span class="purple">strategies and
                solutions </span> to help teams tackle
              real <span class="bold">world challenges</span> </p>
          </div>
          <div class="col-md-5 offset-md-1" data-aos="fade-left">
            <p class="lorem">Figma ipsum component variant main layer. Background follower figjam list opacity slice
              edit stroke. Main style select style hand create. Undo fill.</p>
            <br>
            <br>
        ...
        <div class="container-fluid">
          <div class="row align-items-baseline">
            <div class="col-md-6 offset-md-4" data-aos="fade-left">
              ...
              <p class="lorem">We partner with startups, enterprises, and growing teams to build smart solutions
                that fit their business goals. Whether you're in fintech, healthcare, ecommerce, or education—we’re
                built to adapt, scale, and deliver.</p>
            </div>
  ...
  <section class="section">
    <div class="box-why-us bg-900">
      <div class="container-fluid">
        ...
        <div class="row align-items-center pb-80">
          ...
          <div class="col-md-7" data-aos="fade-left">
            ...
            <br>
            <p class="lorem white pb-50">We empower companies across industries to build smarter, move faster, and
              scale
              fearlessly through reliable tech partnerships.
              <br>
              <br>
              Our strength lies in delivering consistent quality, backed by a talented team, a global mindset, and a
              relentless drive to solve real problems through technology.
            </p>
      ...
      <div class="row  align-items-center   ">
        ...
        <div class="col-md-5 offset-md-1" data-aos="fade-left">
          <p class="lorem white">Discover firsthand experiences from our clients about their journey with
            cybertronlabs insights into our collaboration, expertise, and results delivered.</p>
          <br>
          <br>
